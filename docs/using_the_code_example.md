...
The following example clones the "[Rock Paper Scissors detection](https://github.com/Infineon/mtb-example-psoc-edge-rock-paper-scissors-detection)" application with the desired name "RPS_Detection" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
  project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-rock-paper-scissors-detection --user-app-name RPS_Detection --target-dir "C:/mtb_projects"
   ```
