...
*
* Description      : This file is the header file of USB Webcam functions.
*
...
#define FRAME_INTERVAL_1 (1000000U)    /* configurable FPS Logitech C920e */
#define FRAME_INTERVAL_2 (333332U)    /* 30 FPS 0.3 MP cam */
#define FRAME_INTERVAL   (333333U)    /* 30 FPS 2 MP cam */

#define MAX_VIDEO_INTERFACES (4U)
